...
%'jennifer.jpg');%'justin_glasses.jpg');%'yao.jpg');%'iu.jpg');%
%'beard-champs4.jpg');%'jennifer_xmen.jpg');%'mj.jpg');%'0lliviaa.jpg');
%'4b5d69173e608408ecf97df87563fd34.jpg');%'53e34a746d54adb574ab169d624ccd0a.jpg');%
im2 = imread('justin_glasses.jpg');
im1 = imread('beard-champs4.jpg');
...
% Parameters
warp_pts = [6,8, 12,  23,  35,41, 52];
%           nose,eyeR,eyeL,mouth,chin
hull_pts = [16,19, 27,30, 53,62, 58,65];
...
bbox2 = round(bbox2(index,:).*[1,1,1.4,1.4] - bbox2(index,[3,4,1,2]).*[0.2,0.2,0,0]);
bbox2 = max(bbox2,1);
face2.pos = bbox2([1,2]);
...
im2warp = morph(double(face1.im), im2adj, im1pts, im2pts, tri, 0.5, 1);
